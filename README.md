...
## Aim:
To create a pimg pong game using Unity and C#.
...
In PaddleRight (Negative button - down and positive buttom - up) and paddleLeft(Negative button - s and positive buttom - w)
 ...
 ## Program:
 ```
Program created by: Senthil Kumar S
...
```
 ...
 ## Output:
 ![](https://user-images.githubusercontent.com/93427017/235466570-2b21abef-009b-4db6-8578-df21beca26a8.png)

 ## Result:
 Thus a pimg pong game has been created using Unity and C#.
